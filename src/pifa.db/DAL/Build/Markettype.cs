...
namespace pifa.DAL {
	...
	public partial class Markettype : IDAL {
		...
		public SelectBuild<MarkettypeInfo> Select {
			get { return SelectBuild<MarkettypeInfo>.From(this, SqlHelper.Instance); }
		}
		#endregion
		...
		public MarkettypeInfo GetItem(uint? Id) {
