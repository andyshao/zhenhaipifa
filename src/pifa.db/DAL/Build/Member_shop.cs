...
namespace pifa.DAL {
	...
	public partial class Member_shop : IDAL {
		...
		public SelectBuild<Member_shopInfo> Select {
			get { return SelectBuild<Member_shopInfo>.From(this, SqlHelper.Instance); }
		}
		#endregion
		...
		public Member_shopInfo GetItem(uint? Member_id, uint? Shop_id) {
