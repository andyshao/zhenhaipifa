...
namespace pifa.BLL {
	...
	/// 数据库操作代理类，全部支持走事务
	/// </summary>
	public abstract partial class SqlHelper : pifa.DAL.SqlHelper {
	}
}
namespace pifa.DAL {
	public abstract partial class SqlHelper {
		...
		public static Executer Instance { get; } = new Executer(new LoggerFactory().CreateLogger("pifa_DAL_sqlhelper"), ConnectionString);
